 ...
 */
class RequestHandlerAdaptor: public HTTPTransactionHandler,
		public ResponseHandler {
public:
	explicit RequestHandlerAdaptor(RequestHandler* requestHandler);
	void setHTTPServerAcceptor(HTTPServerAcceptor* acceptor) noexcept;
...
private:
	...
	ResponseHandler* newPushedResponse(PushHandler* pushHandler)
			noexcept override;
	...
	ProxygenError err_ { kErrorNone };bool responseStarted_ { false };
	HTTPServerAcceptor* m_acceptor { nullptr };
};
